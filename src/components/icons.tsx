...
export const Icons = {
  ...
  ethereum: (props: SVGProps<SVGSVGElement>) => (
     <svg
      ...
      fill="currentColor"
    >
      <path d="M16 32C7.163 32 0 24.837 0 16S7.163 0 16 0s16 7.163 16 16-7.163 16-16 16zM16 4.398l-.203.465L9.65 18.157l6.147 3.514 6.35-3.514L16.203 4.863zM16 27.602l.203-.13L22.35 24.18l-6.147-3.513L9.65 24.18z"/>
    </svg>
  ),
};
